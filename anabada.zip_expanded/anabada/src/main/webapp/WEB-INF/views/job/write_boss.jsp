...
<style>
   ...
   #j_pay{
   	  width: 200px;
   	  border: none;
   	  border-bottom: 1px solid #0C6BBC;
   	  padding-bottom: 0;
   }
   textarea{
   	  border: 1px solid #0C6BBC;
...
<body>
	...
	<form name="write_boss" action="/job/write_boss" method="post" enctype="multipart/form-data">
		...
		<div style="width: 1000px; height: 50px; background-color: #0C6BBC; color: #fff;
        margin: auto; text-align: center; vertical-align:middle; display: table-cell;">
		알바 구인 공고
		</div>
		...
		<table>
			...
			<tr>
				<td>
					<textarea id="j_content" name="j_content" style="resize: none;"></textarea>
			...
			<tr>
				<td colspan="4">
					<button type="submit" class="addr1_btn" style="display: block; margin: auto;">작성완료</button>
					<br>
				</td>
			</tr>
		</table>
