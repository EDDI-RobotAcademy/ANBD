...
<div class="aboardcon" style="float: left;"  >
	...
	<form action="">
	<div id="logo_title" >내 상점 </div>
		<table style=" width: 802px; " id="totalTable"  >
		
			<tr class="headTr">
				<td colspan="7" >  <input type="checkbox"   name="delete_all" id="delete_all" > 전체 선택   <button type="button" class="btn btn-light" id="delbtn" >삭제</button> <hr>  </td>
