...
<div class="minicon" style="float: left;"  >
	...
	<span id="title" >내 상점</span>
	<form action="" style="margin-top: 30px;"  >
	
		<table style=" width: 802px; " id="totalTable"  >
		
			<tr class="headTr">
				<td colspan="7" ><input type="checkbox"   name="delete_all" id="delete_all" > 전체 선택 <button type="button" id="delbtn" style="float: right;"  class="btn btn-light"   >삭제</button>  <hr>  </td>
			...
			<c:forEach items="${list }" var="list">
				<tr>
				<td  width="40px;"><input  name="deletes"  type="checkbox" value="${list.pno}" onclick='checkSelectAll()'   ></td>
					<td colspan="6">
