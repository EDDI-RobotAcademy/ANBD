...
// 		})
		...
		// 체크박스 전체 선택
		$(".checkbox_group").on("click", "#termsService", function () {
		...
		$(".checkbox_group").on("click", ".normal", function() {
		    ...
		    $("#termsService").prop("checked", is_checked);
		});
		
	});
	
	function chk(){
		if(document.getElementById('termsService1').checked == false) {
			$("#chkChk").attr("style", "color:#FF0000; padding-left: 5px;");
            $("#chkChk").text("필수 약관에 동의해 주세요.");
		
		} else if(document.getElementById('termsService2').checked == false) {
			$("#chkChk").attr("style", "color:#FF0000; padding-left: 5px;");
            $("#chkChk").text("필수 약관에 동의해 주세요.");
		
		} else if(document.getElementById('termsService1').checked && document.getElementById('termsService2').checked == true) {
...
제1조 (목적)
본 약관은 서비스 이용자가 아나바다(이하 “회사”라 합니다)가 제공하는 온라인 서비스 (이하 “서비스”라 합니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 그 이용자의 권리⋅의무 및 책임 사항을 규정함을 목적으로 합니다.
...
판매자: 물품을 판매하기 위해 회사의 판매자 등록 절차를 완료한 회원(회사가 판매자로서 직접 판매하거나, 위탁판매서비스를 통해 특정 물품의 판매를 위탁 받아 판매하는 경우에는 회사)을 말합니다. 물품의 판매를 업(業)으로 하는 판매자(이하 “통신판매업자인 판매자”, 개인인지 법인인지 여부를 불문)인 경우와 그렇지 아니한 판매자 (이하 이 둘을 통칭하여 “판매자”)인 경우 판매자 등록 절차 및 아나바다 서비스 이용 시 적용되는 권리와 의무에 차이가 있을 수 있습니다.
...
회원은 회사가 제공하는 서비스를 이용함에 있어서 전자상거래 등에서의 소비자보호에 관한 법률, 전자금융거래법, 소비자기본법, 표시∙광고의 공정화에 관한 법률, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령을 준수하여야 하며, 본 약관의 규정을 들어 관련법령 위반에 대한 면책을 주장할 수 없습니다.</textarea>
...
2) 시행일자 : 2018년 05월 01일</textarea>
				...
				<textarea class="terms" readonly>
아나바다 서비스 이용 또는 페이지 이동 중 화면 상/하단 등을 통해서 아나바다가 제공하는 맞춤형 컨텐츠 추천 등 광고 정보를 수신합니다.

아나바다 서비스 이용 중 화면에 보여지는 광고는 이용자 맞춤형 컨텐츠 추천 등 서비스 이용 시 유용한 정보를 제공하고 있습니다.
또한, 광고성 정보제공에 더하여, 인구통계학적 분석, 서비스 방문 및 이용기록의 분석, 개인정보 및 관심에 기반한 신규 맞춤형 서비스(컨텐츠) 요소의 발굴 및 기존 광고 서비스 개선 등을 위하여 개인정보를 이용합니다.
...
본 내용에 동의를 거부하시는 경우에도 아나바다 서비스는 이용이 가능합니다. 다만, 고객 맞춤형 컨텐츠 등 아나바다 이용에 도움이 되는 정보를 수신할 수 없습니다.</textarea>
			...
			<div style="display: flex;">
				<button class="cancel reg-cancle-but" type="button">취소</button>
				<button class="reg-agree-but" type="submit" id="submit" onclick="chk()">확인</button>
			</div>
